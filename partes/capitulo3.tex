...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/entrenamArqui.jpeg}
...
se itera por cada una de las claves de la tabla que se presentó en la sección CAMBIARRRR!!!! \ref{ssec:estructuraNormalizacion}. Si alguno de los elementos de la tabla está contenido en el ``string'' que la función recibe como entrada, entonces se procederá a reemplazar el elemento del párametro de entrada por el valor que posee dicha clave en la ``hash table''. Esta tarea de subsitución se realizará haciendo uso de la función ``subst string'' que proporciona Bro.
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/config.png}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/modeloBro.png}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/modeloOffline.jpg}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/modeloOnline.jpg}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/indicesMalos.png}
...
\begin{figure}[!htb]
\begin{center}
\includegraphics[width=4in]{./img/indicesBuenos.jpg}
